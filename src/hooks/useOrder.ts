...
const useOrder = () => {
  ...
  // fetch order of one perticular user 
  ...
  const userOrder = async () => {
    try {
      ...
      console.log('response i get after sending get request to orders/userOrders', userorders);
      return userorders
    } catch (error) {
      console.log(error);
    }
...
//
  ...
  return { data, loading, error, addOrder, deleteOrder, userOrder };
};
